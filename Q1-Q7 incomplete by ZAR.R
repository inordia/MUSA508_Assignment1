...
# ---- Year 2009 tracts -----
vars09 <- c("B25026_001E","B02001_002E","B15001_050E",
            "B15001_009E","B19013_001E","B25058_001E",
            "B06012_002E")
tracts09 <-  
  get_acs(geography = "tract", vars09, 
          year=2009, state='IL', county='Cook', geometry=T) %>%  
  st_transform('EPSG:26916')

#Clip the boundary 
clip09 <- 
  st_intersection(CTA_boundary,tracts09) %>%
...
#plot the line to show Rent as a function of distance to subway stations of 2009 and 2017
...
#Find the relationship between crime, transit access, and rents (Q7)
...
#count the crime data within each tract
tracts_crime <- allTracts.group
tracts_crime <- st_join(tracts_crime, crime0917, join = st_intersects) 
...
#create crime map
ggplot(tracts_crimecount[st_union(tracts09),])+
...
#Next to do :
#1.Summarize mean rent and crime count and for TOD V.S non-TOD as a table
#2.Create bar plot for mean rent and crime count (TOD V.S non-TOD)
#3.Create a geom_line plot that shows crime count as a function of distance to stations
